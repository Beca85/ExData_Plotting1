...
plot(date.time, data.subset$Global_active_power, type="l", ylab="Global Active Power", xlab="")

plot(date.time, data.subset$Voltage, type="l", ylab="Voltage", xlab="datetime")
...
plot(date.time, data.subset$Global_reactive_power, type="l", ylab="Global_reactive_power", xlab="datetime")
